class Ayamgeprek extends Chitato{
    //Mewarisi  

    int hargaper;
    private String size,kategor,kandungan;
    private String type = " Dengan Khas Bumbu Sambal Aceh";
    String manfaat = "Dengan manfaat Meningkatkatkan Moot dan Optimisme karna rasanya yang lezat dan gurih";

    public Ayamgeprek(String merek, String nama, String kategor, String size, int hargaper, String kandungan)
    {
        super(nama, merek);
